...
class __TwigTemplate_b66bee1dcd2dad69742a8dfd7fe35842 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if secondary %}
  ...
  <ul>{{ secondary }}</ul>
{% endif %}
", "core/modules/system/templates/menu-local-tasks.html.twig", "/Users/arjunrawat/project/drupal-9r/web/core/modules/system/templates/menu-local-tasks.html.twig");
    }
